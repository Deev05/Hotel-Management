...
?>
            ...
            <div class="container-fluid">
                                                ...
                                                <div class="form-group mb-0">
                                                    <select name="room_type_id" id="room_type_id" class="form-control">
                                                        ...
                                                        <?php
                                                            ...
                                                            $room_type_id = $CommonModel->get_by_condition("room_type",$filter);


                                                             if(!empty($room_type_id))
                                                            {
                                                                foreach($room_type_id as $row)
                                                                {
                                                        ?>
                ...
                <div class="row">
                    ...
                    <div id="responsive-modal" class="modal fade edit_rooms" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                ...
                                <form id="update_rooms_form" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <select name="edit_room_type_id" id="edit_room_type_id" class="form-control">
                                                <option value="">Select Room type</option>
                                                <?php
                                                    $filter = array("status" => 1);
                                                    $room_type_id = $CommonModel->get_by_condition("room_type",$filter);
                                        ...
                                        <div class="form-group col-md-12">
                                            <input type="hidden" class="form-control" name="rooms_id" id="rooms_id" value="">
                                        </div>
...
$(document).ready(function() {
                    ...
                    },
                    {
                        ...
                        "render": function(data) {
                            ...
                            return '<div class="btn-group">' +
                                '<a href="javascript:void(0)" class="btn btn-info rooms_modal">' +
    ...
    $('#add_form').validate({ 
		...
		submitHandler: function(form) 
		{
			...
			$.ajax({
				...
				url: '<?php echo base_url(); ?>/Rooms/add_rooms',
    ...
    $(document).on('click', '.rooms_modal', function(e) {
        ...
        var room_type_id            = table.row($(this).closest('tr')).data().room_type_id;
        ...
        $('#edit_room_type_id option').filter(function() {
            return this.textContent == room_type_id
        }).prop('selected', true);
