...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-body">
                    <?php
						$form_location = base_url()."/tax/add_tax";
					?>
                                ...
                                <div class="form-group row mb-0">
                                    <div class="col-md-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group mb-0">
                                                    <input type="text" class="form-control" placeholder="Tax Rate" id="tax_rate" name="tax_rate" />
                                                </div>
                                            </div>
                ...
                <div class="row">
                    ...
                    <!-- Edit tax modal content -->
                    <div id="responsive-modal" class="modal fade edit_tax" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form id="update_tax_form" method="POST" enctype="multipart/form-data">
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group col-md-12">
                                            <label for="recipient-name" class="control-label">Tax Rate</label>
                                            <input type="text" class="form-control" name="edit_rate" id="edit_rate">
                                        </div>
                                        ...
                                        <div class="form-group col-md-12">
                                            <input type="hidden" class="form-control" name="tax_id" id="tax_id" value="">
                                        </div>
                
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default waves-effect" data-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-danger waves-effect waves-light update_tax">Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    var table = $('.show-child-rows').DataTable({
                ...
                "columns": [{
                    ...
                    
                    {
                        ...
                        "data": "id",
                        "render": function(data) {
                            var edit_url = "<?= base_url("tax/create") ?>/" + data;
                            
                            return '<div class="btn-group">' +
                                '<a href="javascript:void(0)" class="btn btn-info tax_modal">' +
    ...
    $(document).on('click', '.status', function() {
        ...
        $.ajax({
            method: "POST",
            url: "<?= base_url(); ?>/tax/change_status/" + id,
    ...
    $('#add_form').validate({ 
		...
		submitHandler: function(form) 
		{
			...
			$.ajax({
				...
				url: '<?php echo base_url(); ?>/tax/add_tax',
