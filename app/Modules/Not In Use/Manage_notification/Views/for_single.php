                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card card-body">
                            ...
                            <form class="form-horizontal m-t-30" id="notification_form" action="<?= base_url("/manage_notification/send_notification") ?>" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    ?>
                                            ...
                                            <option value="<?= $row->id ?>"><?= $row->firstname." ".$row->lastname."(". $row->contact.")" ?></option>
                                    <?php
                                        endforeach
                                    ?>
                                    </select>
