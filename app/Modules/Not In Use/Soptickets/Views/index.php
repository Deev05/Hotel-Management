...
?> 
            ...
            <div class="container-fluid">
                ...
                <!-- ============================================================== -->
                        ...
                        <div class="card-body">
                            <h4 class="card-title text-center mt-3"><?php echo $ticket_details->ticket_no; ?></h4>
...
$(document).ready(function() {
    ...
    function get_conversation_data()
    {
        ...
        $.ajax({
            method: "GET",
            url: "<?= base_url(); ?>/soptickets/get_conversation/<?php echo $ticket_id; ?>",
      ...
      $('#message_form').validate({ 
		...
		submitHandler: function(form) 
		{
			...
			$.ajax({
				...
				url: '<?php echo base_url(); ?>soptickets/send_message',
