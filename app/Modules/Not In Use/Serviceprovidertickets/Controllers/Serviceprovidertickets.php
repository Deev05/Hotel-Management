...
namespace App\Modules\Serviceprovidertickets\Controllers;
use App\Modules\Serviceprovidertickets\Controllers\Notification;
use App\Controllers\BaseController;
use App\Models\CommonModel;

class Serviceprovidertickets extends BaseController
{
    ...
    public function index()
    {
        ...
        echo view('App\Modules\Serviceprovidertickets\Views\index', $data);
    ...
    public function single()
    {
        ...
        echo view('App\Modules\Admin\Views\header', $data);
        echo view('App\Modules\Serviceproviderhome\Views\service_provider_sidebar', $data);
        echo view('App\Modules\Serviceprovidertickets\Views\single', $data);
        echo view('App\Modules\Admin\Views\footer', $data);
    }
    ...
    public function change_ticket_status()
    {
        ...
        if ($update != false) {
            ...
            $data['service_providers']=$this->CommonModel->get_single("service_providers",array('id'=>$data['ticekt_data']->service_provider_id));



            $filter         = array("id" => $service_provider_id);
            $service_providers           = $this->CommonModel->get_single("service_providers",$filter);
            $token          = $service_providers->token;
